    ...
    r(l, [], function () {
        ...
        function c(e, t, r, i) {
            i = i || this, e && (r && (e = e[r]), n.each(e, function (e, n) {
                return t.call(i, e, n, r) === !1 ? !1 : void c(e, t, r, i)
            }))
        }
        ...
        return function (e, t) {
            ...
            var r = /rgb\s*\(\s*([0-9]+)\s*,\s*([0-9]+)\s*,\s*([0-9]+)\s*\)/gi, i = /(?:url(?:(?:\(\s*\"([^\"]+)\"\s*\))|(?:\(\s*\'([^\']+)\'\s*\))|(?:\(\s*([^)\s]+)\s*\))))|(?:\'([^\']+)\')|(?:\"([^\"]+)\")/gi, o = /\s*([^:]+):\s*([^;]+);?/g, a = /\s+$/, s, l = {}, c, u, d, f = "\ufeff";
                ...
                toHex: function (e) {
                    ...
                    function c(e, t, n) {
                        ...
                        if (r = y[e + "-top" + t], r && (i = y[e + "-right" + t], i && (o = y[e + "-bottom" + t], o && (a = y[e + "-left" + t])))) {
                            ...
                            s > -1 && n || (y[e + t] = -1 == s ? l[0] : l.join(" "), delete y[e + "-top" + t], delete y[e + "-right" + t], delete y[e + "-bottom" + t], delete y[e + "-left" + t])
                        }
                    }
                    ...
                    if (t) {
                        for (t = t.replace(/[\u0000-\u001F]/g, ""), t = t.replace(/\\[\"\';:\uFEFF]/g, h).replace(/\"[^\"]+\"|\'[^\']+\'/g, function (e) {
                            ...
                            if (C = g(C), x = g(x), -1 !== C.indexOf(f) || -1 !== C.indexOf('"'))continue;
                    ...
                    function n(t) {
                        var n, r, o, a;
                        if (n = u[t])for (r = 0, o = n.length; o > r; r++)t = n[r], a = e[t], a && (i += (i.length > 0 ? " " : "") + t + ": " + a + ";")
                    }

                    function r(e, t) {
                        var n;
                        return n = d["*"], n && n[e] ? !1 : (n = d[t], !n || !n[e])
                    }

                    var i = "", o, a;
                    if (t && u)n("*"), n(t); else for (o in e)a = e[o], !a || d && !r(o, t) || (i += (i.length > 0 ? " " : "") + o + ": " + a + ";");
                    return i
                }
            }
        }
        ...
        function d(e) {
            this.walk = function (t, n) {
                ...
                var l = t.startContainer, c = t.startOffset, u = t.endContainer, d = t.endOffset, f, h, m, g, v, y, b;
        ...
        var p = e.each, m = n.isContentEditableTrue, g = n.isContentEditableFalse, v = i.isCaretContainer;
        ...
        function i(i, a) {
            ...
            i = i || {}, l.schema = a = a || new e, i.fix_self_closing !== !1 && (i.fix_self_closing = !0), o("comment cdata text start end pi doctype".split(" "), function (e) {
                ...
                var l = this, c, u = 0, d, f, h = [], p, m, g, v, y, b, C, x, w, E, N, _, S, k, T, R, A, B, D, L, M, P, O, H, I, F = 0, z = t.decode, U, W = n.makeMap("src,href,data,background,formaction,poster"), V = /((java|vb)script|mhtml):/i, $ = /^data:/i;
                for (P = new RegExp("<(?:(?:!--([\\w\\W]*?)-->)|(?:!\\[CDATA\\[([\\w\\W]*?)\\]\\]>)|(?:!DOCTYPE([\\w\\W]*?)>)|(?:\\?([^\\s\\/<>]+) ?([\\w\\W]*?)[?/]>)|(?:\\/([^>]+)>)|(?:([A-Za-z0-9\\-_\\:\\.]+)((?:\\s+[^\"'>]+(?:(?:\"[^\"]*\")|(?:'[^']*')|[^>]*))*|\\/|\\s+)>))", "g"), O = /([\w:\-]+)(?:\s*=\s*(?:(?:\"((?:[^\"])*)\")|(?:\'((?:[^\'])*)\')|([^>\s]+)))?/g, C = a.getShortEndedElements(), M = i.self_closing_elements || a.getSelfClosingElements(), x = a.getBoolAttrs(), E = i.validate, b = i.remove_internals, U = i.fix_self_closing, H = a.getSpecialElements(); c = P.exec(e);) {
                    if (u < c.index && l.text(z(e.substr(u, c.index - u))), d = c[6])d = d.toLowerCase(), ":" === d.charAt(0) && (d = d.substr(1)), o(d); else if (d = c[7]) {
                        if (d = d.toLowerCase(), ":" === d.charAt(0) && (d = d.substr(1)), w = d in C, U && M[d] && h.length > 0 && h[h.length - 1].name === d && o(d), !E || (N = a.getElementRule(d))) {
                            if (_ = !0, E && (T = N.attributes, R = N.attributePatterns), (k = c[8]) ? (y = -1 !== k.indexOf("data-mce-type"), y && b && (_ = !1), p = [], p.map = {}, k.replace(O, s)) : (p = [], p.map = {}), E && !y) {
        ...
        return function (l, c) {
            function u(t) {
                ...
                for (m = i("tr,td,th,tbody,thead,tfoot,table"), p = c.getNonEmptyElements(), g = c.getTextBlockElements(), v = c.getSpecialElements(), n = 0; n < t.length; n++)if (r = t[n], r.parent && !r.fixed)if (g[r.name] && "li" == r.parent.name) {
            ...
            var d = this, f = {}, h = [], p = {}, m = {};
            l = l || {}, l.validate = "validate" in l ? l.validate : !0, l.root_name = l.root_name || "body", d.schema = c = c || new t, d.filterNode = function (e) {
                var t, n, r;
                ...
                o(a(e), function (e) {
                    var n;
                    for (n = 0; n < h.length; n++)if (h[n].name === e)return void h[n].callbacks.push(t);
                    h.push({name: e, callbacks: [t]})
                })
                ...
                var v, y, b, C, x, w, E, N, _, S, k, T, R, A = [], B, D, L, M, P, O, H, I;
                if (r = r || {}, p = {}, m = {}, T = s(i("script,style,head,html,body,title,meta,param"), c.getBlockElements()), H = c.getNonEmptyElements(), O = c.children, k = l.validate, I = "forced_root_block" in r ? r.forced_root_block : l.forced_root_block, P = c.getWhiteSpaceElements(), R = /^[ \t\r\n]+/, D = /[ \t\r\n]+$/, L = /[ \t\r\n]+/g, M = /^[ \t\r\n]+$/, v = new n({
                    ...
                    for (S in p) {
                        ...
                        for (x = 0, w = _.length; w > x; x++)_[x](C, S, r)
                    }
                    for (x = 0, w = h.length; w > x; x++)if (_ = h[x], _.name in m) {
                        for (C = m[_.name], E = C.length; E--;)C[E].parent || C.splice(E, 1);
                        for (E = 0, N = _.callbacks.length; N > E; E++)_.callbacks[E](C, _.name, r)
                    }
                }
                return y
            }, l.remove_trailing_brs && d.addNodeFilter("br", function (t) {
                var n, r = t.length, i, o = s({}, c.getBlockElements()), a = c.getNonEmptyElements(), l, u, d, f, h, p;
                for (o.body = 1, n = 0; r > n; n++)if (i = t[n], l = i.parent, o[i.parent.name] && i === l.lastChild) {
                    for (d = i.prev; d;) {
        ...
        return function (e, o) {
            ...
            function m(e) {
                var t = e, r = /<(\w+) [^>]*data-mce-bogus="all"[^>]*>/g, i, a, s, l, c, u = o.schema;
            ...
            function v(e) {
                -1 === l.inArray(x, e) && (C.addAttributeFilter(e, function (e, t) {
            ...
            this.getBookmark = function (e, u) {
                ...
                function h(e) {
                    function t(e, t) {
                        ...
                        if (3 == r.nodeType) {
                            if (u)for (a = r.previousSibling; a && 3 == a.nodeType; a = a.previousSibling)i += a.nodeValue.length;
                            o.push(i)
                ...
                function o(r) {
                    var i = c.get(n.id + "_" + r), o, a, s, l, u = n.keep;
        ...
        function r(e, r) {
            ...
            function a(e, n) {
                ...
                return o && o.length ? n && -1 !== t.inArray(o, n) ? n : o[0] : !1
            }

            function s(e, n, r) {
                var i, l, u, d = n.length && n[0], f = d && d.name;
                if (u = a(e, f))f == u ? (l = n[0], n = n.slice(1)) : l = u; else if (d)l = n[0], n = n.slice(1); else if (!r)return e;
            ...
            function x(t, n, r) {
                ...
                function o(e, t) {
                    ...
                    return h.selector ? (ue(e, function (e) {
                        return "collapsed" in e && e.collapsed !== v ? void 0 : Y.is(t, e.selector) && !f(t) ? (i(t, e), n = !0, !1) : void 0
                    }), n) : !1
                }
                ...
                var d = m(t), h = d[0], p, g, v = !r && X.isCollapsed();
                if ("false" !== ae(X.getNode())) {
                    if (h) {
                        if (r)r.nodeType ? o(d, r) || (g = Y.createRng(), g.setStartBefore(r), g.setEndAfter(r), u(H(g, d), null, !0)) : u(r, null, !0); else if (v && h.inline && !Y.select("td[data-mce-selected],th[data-mce-selected]").length)$("apply", t, n); else {
                    ...
                    r = X.getNode();
                    for (var b = 0, w = d.length; w > b; b++)if (d[b].ceFalseOverride && Y.is(r, d[b].selector))return void i(r, d[b])
                }
            }
        ...
        var e = 0, t = 1, n = 2, r = function (r, i) {
            var o = r.length + i.length + 2, a = new Array(o), s = new Array(o), l = function (e, t, n) {
                ...
                var f = d(o, a, s, l);
                if (null === f || f.start === a && f.diag === a - l || f.end === o && f.diag === o - s)for (var h = o, p = s; a > h || l > p;)a > h && l > p && r[h] === i[p] ? (u.push([e, r[h]]), ++h, ++p) : a - o > l - s ? (u.push([n, r[h]]), ++h) : (u.push([t, i[p]]), ++p); else {
                    c(o, f.start, s, f.start - f.diag, u);
                    for (var m = f.start; m < f.end; ++m)u.push([e, r[m]]);
                    c(f.end, a, f.end - f.diag, l, u)
                }
            }, u = function (e, t, n, o) {
                for (var a = e; o > a - t && n > a && r[a] === i[a - t];)++a;
                return l(e, a, t)
            }, d = function (e, t, n, o) {
                var l = t - e, c = o - n;
                if (0 === l || 0 === c)return null;
                var d = l - c, f = c + l, h = (f % 2 === 0 ? f : f + 1) / 2;
                a[1 + h] = e, s[1 + h] = t + 1;
                for (var p = 0; h >= p; ++p) {
                    for (var m = -p; p >= m; m += 2) {
                        var g = m + h;
                        m === -p || m != p && a[g - 1] < a[g + 1] ? a[g] = a[g + 1] : a[g] = a[g - 1] + 1;
                        for (var v = a[g], y = v - e + n - m; t > v && o > y && r[v] === i[y];)a[g] = ++v, ++y;
                        if (d % 2 != 0 && m >= d - p && d + p >= m && s[g - d] <= a[g])return u(s[g - d], m + e - n, t, o)
                    }
                    for (m = d - p; d + p >= m; m += 2) {
                        for (g = m + h - d, m === d - p || m != d + p && s[g + 1] <= s[g - 1] ? s[g] = s[g + 1] - 1 : s[g] = s[g - 1], v = s[g] - 1, y = v - e + n - m; v >= e && y >= n && r[v] === i[y];)s[g] = v--, y--;
                        if (d % 2 === 0 && m >= -p && p >= m && s[g] <= a[g + d])return u(s[g], m + e - n, t, o)
                    }
                }
            }, f = [];
        ...
        return function (e) {
            ...
            return e.on("init", function () {
                ...
                var a = t.keyCode;
                t.isDefaultPrevented() || ((a >= 33 && 36 >= a || a >= 37 && 40 >= a || 45 === a || t.ctrlKey) && (o(), e.nodeChanged()), (46 === a || 8 === a || r.mac && (91 === a || 93 === a)) && e.nodeChanged(), d && s.typing && (e.isDirty() || (i(c[0] && !n.isEq(n.createFromEditor(e), c[0])), e.isDirty() && e.fire("change", {
                    level: c[0],
                    lastLevel: null
                ...
                if (!e.isDefaultPrevented()) {
                    if (t >= 33 && 36 >= t || t >= 37 && 40 >= t || 45 === t)return void(s.typing && o(e));
                    var n = e.ctrlKey && !e.altKey || e.metaKey;
                    !(16 > t || t > 20) || 224 === t || 91 === t || s.typing || n || (s.beforeChange(), s.typing = !0, s.add({}, e), d = !0)
                }
                ...
                data: c, typing: !1, beforeChange: function () {
                    ...
                    var p = {level: r, lastLevel: d, originalEvent: o};
                    return e.fire("AddUndo", p), l > 0 && (i(!0), e.fire("change", p)), r
                }, undo: function () {
                    var t;
                    return s.typing && (s.add(), s.typing = !1), l > 0 && (t = c[--l], n.applyToEditor(e, t, !0), i(!0), e.fire("undo", {level: t})), t
                }, redo: function () {
                    var t;
                    return l < c.length - 1 && (t = c[++l], n.applyToEditor(e, t, !1), i(!0), e.fire("redo", {level: t})), t
                }, clear: function () {
            ...
            function a(a) {
                ...
                function y(t) {
                    ...
                    if (t) {
                        ...
                        } else"BR" == t.nodeName ? t.nextSibling && s.isBlock(t.nextSibling) ? ((!O || 9 > O) && (u = s.create("br"), t.parentNode.insertBefore(u, t)), a.setStartBefore(t), a.setEndBefore(t)) : (a.setStartAfter(t), a.setEndAfter(t)) : (a.setStart(t, 0), a.setEnd(t, 0));
                ...
                function x(e) {
                    ...
                    if (e || "TABLE" == U ? (n = s.create(e || V), b(n)) : n = P.cloneNode(!1), o = n, c.keep_styles !== !1)do if (a[t.nodeName]) {
                ...
                if (A = l.getRng(!0), !a.isDefaultPrevented()) {
                    ...
                    if (new t(s).normalize(A), L = A.startContainer, M = A.startOffset, V = (c.force_p_newlines ? "p" : "") || c.forced_root_block, V = V ? V.toUpperCase() : "", O = s.doc.documentMode, H = a.shiftKey, 1 == L.nodeType && L.hasChildNodes() && ($ = M > L.childNodes.length - 1, L = L.childNodes[Math.min(M, L.childNodes.length - 1)] || L, M = $ && 3 == L.nodeType ? L.nodeValue.length : 0), D = k(L)) {
                        ...
                        V && P === o.getBody() || (V = V || "P", n.isCaretContainerBlock(P) ? I = n.showCaretContainerBlock(P) : w() ? R() : w(!0) ? (I = P.parentNode.insertBefore(x(), P), g(I), y(P)) : (B = A.cloneRange(), B.setEndAfter(P), F = B.extractContents(), S(F), I = F.firstChild, s.insertAfter(F, P), v(I), T(P), s.isEmpty(P) && C(P), I.normalize(), s.isEmpty(I) ? (s.remove(I), R()) : y(I)), s.setAttrib(I, "id", ""), o.fire("NewBlock", {newBlock: I}), u.typing = !1, u.add())
                    }
                }
            }

            var s = o.dom, l = o.selection, c = o.settings, u = o.undoManager, d = o.schema, f = d.getNonEmptyElements(), h = d.getMoveCaretBeforeOnEnterElements();
        ...
        function c(e, n, r, i, o) {
            ...
            if (s(n)) {
                ...
                for (; e = l(c.prev, o);)if (r(e))return e
            }
            if (a(n)) {
                if ((x(e) || N(e)) && (e = l(c.next, !0), r(e)))return e;
                for (; e = l(c.next, o);)if (r(e))return e
            }
            return null
        }
        ...
        function y(e, t, r) {
            var o, a, s, l, c = _(v, !0, t), u = _(v, !1, t);
            ...
            if (n.isText(a)) {
                ...
                if (i.startsWithCaretContainer(a) && 1 >= s)return -1 === e && (o = c(a)) ? R(o) : r;
        ...
        var l = a.matchNodeNames("td th"), c = function (a, c, u) {
            ...
            var b, C, x, w, E, N, _, S, k, T, R, A, B = a.schema.getTextInlineElements(), D = a.selection, L = a.dom;
            /^ | $/.test(c) && (c = d(c)), b = a.parser, A = u.merge, C = new n({validate: a.settings.validate}, a.schema), R = '<span id="mce_marker" data-mce-type="bookmark">&#xFEFF;&#x200B;</span>', N = {
                content: c,
                format: "html",
                selection: !0
            }, a.fire("BeforeSetContent", N), c = N.content, -1 == c.indexOf("{$caret}") && (c += "{$caret}"), c = c.replace(/\{\$caret\}/, R), S = D.getRng();
            ...
            if (p(E), k = E.lastChild, "mce_marker" == k.attr("id"))for (_ = k, k = k.prev; k; k = k.walk(!0))if (3 == k.type || !L.isBlock(k.name)) {
        ...
        return function (r) {
            function i() {
                return f.length ? f[f.length - 1] : void 0
            }
        ...
        return function (f) {
            ...
            function b() {
                ...
                function h(e, t) {
                    ...
                    if (t.collapsed && (d = t.startContainer, h = t.startOffset, a = x.getParent(d, x.isBlock), i(a)))if (1 == d.nodeType) {
        ...
        return function () {
            function n(e, t, n, r) {
                return {id: u(e), filename: u(r || e), blob: u(t), base64: u(n), blobUri: u(URL.createObjectURL(t))}
            }
        ...
        return function (o) {
            ...
            function p(e) {
                return w.automatic_uploads !== !1 ? h(e) : void 0;
            }

            function m(e) {
                return w.images_dataimg_filter ? w.images_dataimg_filter(e) : !0
            }
            ...
            var b = new r, C, x, w = o.settings, E = new i;
            ...
            }), {blobCache: b, uploadImages: h, uploadImagesAuto: p, scanForImages: g, destroy: v}
        }
        ...
        function v(c) {
            ...
            function B(e) {
                var t;
                return t = c.fire("BeforeObjectSelected", {target: e}), t.isDefaultPrevented() ? null : D(e)
            }
            ...
            function O(e, t, n, r) {
                var i, o, a, s;
                return !r.collapsed && (i = N(r), C(i)) ? A(e, i, -1 == e) : (s = P(r), o = M(e, r), n(o) ? B(o.getNode(-1 == e)) : (o = t(o)) ? n(o) ? A(e, o.getNode(-1 == e), 1 == e) : (a = t(o), n(a) && L(o, a) ? A(e, a.getNode(-1 == e), 1 == e) : s ? $(o.toRange()) : null) : s ? r : null)
            }
            ...
            function H(e, t, n) {
                ...
                if (u = c.left, l = s.findClosestClientRect(o, u), l && C(l.node))return d = Math.abs(u - l.left), f = Math.abs(u - l.right), A(e, l.node, f > d);
                if (p) {
            ...
            function K(e, t, n, i) {
                var o, a, s, l;
                return !i.collapsed && (o = N(i), C(o)) ? $(q(o)) : (a = M(e, i), n(a) && r.isCaretContainerBlock(i.startContainer) ? (l = -1 == e ? ie.prev(a) : ie.next(a), l ? $(l.toRange()) : i) : t(a) ? $(q(a.getNode(-1 == e))) : (s = -1 == e ? ie.prev(a) : ie.next(a), t(s) ? -1 === e ? X(e, a, s) : X(e, s, a) : void 0))
            }
            ...
            function G() {
                ...
                function g() {
                    ...
                    b(t) && S(t) && c.dom.isEmpty(t) && (e = c.dom.create("br", {"data-mce-bogus": "1"}), c.$(t).empty().append(e), c.selection.setRng(n.before(e).toRange()))
                }
                ...
                f(c), c.on("mousedown", function (e) {
                    var t;
                    if (t = o(e.target))C(t) ? (e.preventDefault(), Z(B(t))) : l(e.clientX, e.clientY, c.selection.getRng()) || c.selection.placeCaretAt(e.clientX, e.clientY); else {
                        ee(), ne();
            ...
            var re = c.getBody(), ie = new t(re), oe = y(g, ie.next), ae = y(g, ie.prev), se = new o(c.getBody(), S), le = "sel-" + c.dom.uniqueId(), ce, ue = c.$;
        ...
        var L = e.DOM, M = r.ThemeManager, P = r.PluginManager, O = E.extend, H = E.each, I = E.explode, F = E.inArray, z = E.trim, U = E.resolve, W = g.Event, V = w.gecko, $ = w.ie;
        return D.prototype = {
            render: function () {
                function e() {
                ...
                function t() {
                    ...
                    if (r.language && "en" != r.language && !r.language_url && (r.language_url = n.editorManager.baseURL + "/langs/" + r.language + ".js"), r.language_url && e.add(r.language_url), r.theme && "function" != typeof r.theme && "-" != r.theme.charAt(0) && !M.urls[r.theme]) {
                        var t = r.theme_url;
                        t = t ? n.documentBaseURI.toAbsolute(t) : "themes/" + r.theme + "/theme" + o + ".js", M.load(r.theme, t)
                    }
                    E.isArray(r.plugins) && (r.plugins = r.plugins.join(" ")), H(r.external_plugins, function (e, t) {
                        ...
                        if (e = z(e), e && !P.urls[e])if ("-" == e.charAt(0)) {
                        ...
                        } else P.load(e, {prefix: "plugins/", resource: e, suffix: "/plugin" + o + ".js"})
                ...
                function e(n) {
                    var r = P.get(n), i, o;
                    if (i = P.urls[n] || t.documentBaseUrl.replace(/\/$/, ""), n = z(n), r && -1 === F(m, n)) {
                ...
                t && (e = O({content: e}, t)), this.execCommand("mceInsertContent", !1, e)
            }, isDirty: function () {
        ...
        return {
            setCode: function (e) {
                e && (n = e, this.rtl = this.data[e] ? "rtl" === this.data[e]._dir : !1)
            }, getCode: function () {
                return n
        ...
        return x = {
            ...
            init: function (n) {
                ...
                function d() {
                    ...
                    return m.unbind(window, "ready", d), l("onpageload"), g = t.unique(u(n)), n.types ? void v(n.types, function (e) {
                        o.each(g, function (t) {
                            return m.is(t, e.selector) ? (a(s(t), y({}, n, e), t), !1) : !0
                        })
                    }) : (o.each(g, function (e) {
                        p(f.get(e.id))
            ...
            remove: function (e) {
                var t = this, n, r = t.editors, i;
                {
                    ...
                    })) : (i = e, r[i.id] ? (h(i) && t.fire("RemoveEditor", {editor: i}), r.length || m.unbind(window, "beforeunload", C), i.remove(), f(r, r.length > 0), i) : null);
        ...
        return e.extend({
            init: function (e) {
                ...
                var e = this, t = e.getEl(), i = e.getEl("open"), o = e.layoutRect(), a, s, l = 0, c = t.firstChild;
                ...
                var e = this, t = e._id, n = e.settings, r = e.classPrefix, i = e.state.get("value") || "", o, a, s = "", l = "", c = "";
        ...
        var a = {}, s = 5, l = function (e) {
            ...
            var l = {title: "-"}, h = function (e) {
                ...
                var e = p("anchor"), t = f(s, "anchor_top", "#top"), n = f(s, "anchor_bottom", "#bottom");
            ...
            var r = a[t];
            /^https?/.test(e) && (r ? -1 === n.indexOf(r, e) && (a[t] = r.slice(0, s).concat(e)) : a[t] = [e])
        }, m = function (e, n) {
        ...
        function u(e) {
            ...
            p = o(), d({
                ...
                e.addButton(n, {
                    tooltip: t, onPostRender: a(n), onclick: function () {
                        c(n)
                    }
                })
            }), d({
                ...
                e.addButton(n, {tooltip: t[0], cmd: t[1], onPostRender: a(n)})
            });
            var m = function (e) {
                var t = e;
                ...
                var n, i;
                if ("string" == typeof t)i = t.split(" "); else if (r.isArray(t))return f(r.map(t, g));
            ...
            e.addButton("undo", {
                ...
                type: "menubutton", text: "Formats", menu: p, onShowMenu: function () {
                    e.settings.style_formats_autohide && h(this.menu)
                }
            }), e.addButton("formatselect", function () {
                var n = [], r = i(e.settings.block_formats || "Paragraph=p;Heading 1=h1;Heading 2=h2;Heading 3=h3;Heading 4=h4;Heading 5=h5;Heading 6=h6;Preformatted=pre");
                ...
                }), {type: "listbox", text: r[0][0], values: n, fixedWidth: !0, onselect: c, onPostRender: t(n)}
        ...
        var i = e.extend({
            init: function (e) {
                ...
                }).fire("show")), e.menu.show(), e.menu.layoutRect({w: e.layoutRect().w}), e.menu.moveRel(e.getEl(), e.isRtl() ? ["br-tr", "tr-br"] : ["bl-tl", "tl-bl"]), void e.fire("showmenu"))
            }, hideMenu: function () {
                var e = this;
        ...
        return e.extend({
            Defaults: {border: 0, role: "menuitem"}, init: function (e) {
                ...
                var o = this, a = o._id, s = o.settings, l = o.classPrefix, c = o.state.get("text"), u = o.settings.icon, d = "", f = s.shortcut, h = o.encode(s.url), p = "";
